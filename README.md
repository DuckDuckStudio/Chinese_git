...
> 项目LICENSE：GPL-2.0<br>
> 你也可以查看 中文Git 的[用户手册](https://github.com/DuckDuckStudio/Chinese_git/blob/main/USER_HANDBOOK.md)来了解更多信息。<br>
...
> [!NOTE]
> 对于`配置`命令，请将配置范围放在**第三个参数**<br>
> 对于`提交`命令，如果**提交信息带空格请用`"`将提交信息括起来**<br>
> 对于`新建分支`命令，该命令会在新建完分支后**自动签出到新分支**<br>
